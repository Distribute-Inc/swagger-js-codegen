...
var getJSCode = function(opts, type) {
    ...
    } else if(type==='angular-key') {
        tpl = fs.readFileSync(__dirname + '/../templates/angular-class-with-key.mustache', 'utf-8');
        method = fs.readFileSync(__dirname + '/../templates/method-with-key.mustache', 'utf-8');
...
var getTypeScriptMethodDefinitionNoKey = function(opts, resultTypeFn){
    if (opts.swagger.swagger !== '2.0') {
        throw 'Typescript is only supported for Swagger 2.0 specs.';
    }

    var data = opts.swagger.swagger === '2.0' ? getViewForSwagger2(opts) : getViewForSwagger1(opts);
    var tpl = fs.readFileSync(__dirname + '/../templates/method_types.mustache', 'utf-8');
    var typeTpl = fs.readFileSync(__dirname + '/../templates/type.mustache', 'utf-8');
    data.resultFn = function () {
        return function (tmpl, render) {
            return resultTypeFn(render(tmpl));
...
exports.CodeGen = {
    ...
    getAngularCodeWithKey: function(opts) {
      return getJSCode(opts, 'angular-key')
    },
    ...
    getAngularTypeScriptDefinitionNoKey: function(opts) {
      return getTypeScriptMethodDefinitionNoKey(opts, function(resultType) {
        return 'ng.IPromise<' + resultType + '>';
      });
    }
};
